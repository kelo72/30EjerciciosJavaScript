    ...
    const inventors = [
      ...
      const invFilter = inventors.filter(inventor => inventor.year >= 1500 && inventor.year < 1600);
      
      console.table(invFilter)
      ...
      //probar el codigo en la consola de chrome en la paguina citada arriba
      ...
      */
      ...
      const reduce = data.reduce(function(obj, item) {
        if(!obj[item]){
          obj[item] = 0
        }
        obj[item] ++
